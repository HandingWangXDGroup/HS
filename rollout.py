...
class RolloutWorker:
    ...
    def generate_episode(self, episode_num=None, evaluate=False):
        ...
        while not game_over and step < self.episode_limit:
            # time.sleep(0.2)
            ...
            reward, game_over, score = self.env.play_step(actions)
            win_tag = True if game_over and score == 1 else False
            o.append(obs)
            s.append(state)
